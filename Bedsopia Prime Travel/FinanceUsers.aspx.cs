...
{
    public partial class FinanceUsers : System.Web.UI.Page
    {
        ...
        protected void UserList()
        {
            try
            {
                string query = "  SELECT Users.Logicalref,Users.UserName,Users.UserSurName,Users.Email,UserType.FinanceUserType FROM PRIMETRAVEL_JUNIPER..FinanceUser Users LEFT JOIN PRIMETRAVEL_JUNIPER..FinanceUserType UserType ON Users.UserTypeId=UserType.Logicalref WHERE Users.Status='1' AND Users.UserTypeId !='1' Order BY Users.Logicalref DESC";
        ...
        protected void KayitSil(string silinecekId)
        {
            try
            {
                string sql = @"UPDATE FinanceUser SET Status='0' WHERE Logicalref='" + silinecekId + "'";
