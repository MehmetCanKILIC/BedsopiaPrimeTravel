<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceSupplierCard.aspx.cs" Inherits="Bedsopia_Prime_Travel.FinanceSupplierCard" MasterPageFile="~/Prime.Master" %>
                                    ...
                                    <itemtemplate>
                                        <tr style="width: 70%;">
                                            ...
                                            <td style="text-align: right;">
                                                <a href="FinanceSupplierCardDetail.aspx?SupplierId=<%#Eval("SupplierId") %>" class="btn bg-grey waves-effect" ><i class="material-icons">details</i></a>
                                                <a href="InvoiceSendMail.aspx?SupplierId=<%#Eval("SupplierId") %>" class="btn bg-grey waves-effect fancybox" data-fancybox-type="iframe" data-width="85%" data-height="85%"><i class="material-icons">send</i></a>
