<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BookingReminder.aspx.cs" Inherits="Bedsopia_Prime_Travel.BookingReminder" %>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div style="float: right;">
                    ...
                    <asp:LinkButton ID="btnKaydet" runat="server" CssClass="btn bg-blue waves-effect" OnClick="btnKaydet_Click"><i class="material-icons">&nbsp;&nbsp; send</i>
                                    <span>REMINDER</span></asp:LinkButton>
