<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StopSale.aspx.cs" Inherits="Bedsopia_Prime_Travel.StopSale" MasterPageFile="~/Bedsopia.Master" %>
            ...
            <div class="card">
                ...
                <div class="body">
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-10">
                            <div class="form-line">
                                <asp:ListBox ID="dropRoom" required CssClass="form-control show-tick" ValidationGroup="control"  runat="server" SelectionMode="Multiple"></asp:ListBox>
                        ...
                        <div class="col-sm-10">
                            <div class="form-line">
                                <asp:ListBox ID="dropBoard" required runat="server" ValidationGroup="control" CssClass="form-control show-tick" SelectionMode="Multiple"></asp:ListBox>
                        ...
                        <div class="col-sm-10">
                            <div class="form-line">
                                <asp:ListBox ID="dropNationality" required runat="server" ValidationGroup="control" CssClass="form-control show-tick" SelectionMode="Multiple"></asp:ListBox>
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="control" runat="server" ControlToValidate="dropNationality" InitialValue="0" ErrorMessage="*" CssClass="bg-red"></asp:RequiredFieldValidator>
                                        ...
                                        <td>
                                            <div class="col-lg-10" style="margin-bottom: 0;">
                                                <div class="form-group">
                                                    <div class="form-line">
                                                        <asp:TextBox ID="txtCheckIn" ValidationGroup="control" Style="font-size: medium;" Text='<%#Eval("CheckIn") %>' required runat="server" CssClass="datepicker date_tr form-control" placeholder="CheckIn"></asp:TextBox>
                        ...
                        <br />
                           ...
                           <div class="col-sm-2">
                            <span class="input-group-addon bilgiBaslik" style="border: none; background-color: transparent; padding-left: 0; font-weight: bold;">Minumum Stay</span>
                        </div>
                        <div class="col-lg-10" style="margin-bottom: 0;">
                            <div class="form-group">
                                <div class="form-line">
                                    <asp:TextBox ID="txtMinumumStay" CssClass="form-control"  Style="font-size: medium; width: 100%;" runat="server" placeholder="Minumum Stay"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-2">
