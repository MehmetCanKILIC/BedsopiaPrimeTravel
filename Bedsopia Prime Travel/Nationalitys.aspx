<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Nationalitys.aspx.cs" Inherits="Bedsopia_Prime_Travel.Nationalitys" MasterPageFile="~/Bedsopia.Master"  %>
            ...
            <div class="card">
                ...
                <div class="body table-responsive" style="background-color: white;">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <asp:ListView ID="lvNationalityTypes" runat="server" OnPagePropertiesChanged="lvNationalityTypes_PagePropertiesChanged">
                                <ItemTemplate>
                                    <tr style="width: 70%;">
                                        <td><strong><%#Eval("NationalityId") %></strong></td>
                                        <td><%#Eval("Nationality") %></td>
                                        <td style="text-align: right;">
                                            <a href="Nationalitys.aspx?RoomId=<%#Eval("NationalityId") %>" class="btn bg-grey waves-effect fancybox" data-fancybox-type="iframe" data-width="65%" data-height="53%"><i class="material-icons">input</i></a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:ListView>
