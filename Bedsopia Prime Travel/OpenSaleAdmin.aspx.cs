...
{
    public partial class OpenSaleAdmin : System.Web.UI.Page
    {
        ...
        protected void DataLists()
        {
            try
            {
                ...
                query += "";
                query += " LEFT JOIN[Users] users on users.UserId = Sale.UserId  WHERE sale.Type=1 ORDER BY sale.SaleId DESC ";
