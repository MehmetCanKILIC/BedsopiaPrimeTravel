<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StopSaleAdmin.aspx.cs" Inherits="Bedsopia_Prime_Travel.StopSaleAdmin" MasterPageFile="~/Prime.Master" %>
                        ...
                        <tbody>
                            <asp:ListView ID="lvOpenSaleList" runat="server" OnPagePropertiesChanged="lvOpenSaleList_PagePropertiesChanged" OnItemDataBound="lvOpenSaleList_ItemDataBound">
                                <ItemTemplate>
                                    <tr style="width: 70%;">
                                        <td>
                                            <asp:Literal ID="ltrUyari" runat="server"></asp:Literal></td>
                                        <td><strong><%#Eval("SaleId") %></strong></td>
                                        ...
                                        <td style="text-align: center;">
                                            <asp:Literal ID="ltrSaleCount" runat="server"></asp:Literal></td>

                                        <td style="text-align: right;">
                                            <%#Eval("Status").ToString() != "1" ? "<a href=\"StopSaleAdmin.aspx?SaleId="+Eval("SaleId")+"\" class=\"btn bg-grey waves-effect\"><i class=\"material-icons\">check_circle</i></a>": "" %>
