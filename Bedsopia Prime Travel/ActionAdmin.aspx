<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ActionAdmin.aspx.cs" Inherits="Bedsopia_Prime_Travel.ActionAdmin" MasterPageFile="~/Bedsopia.Master"%>
            ...
            <div class="card">
                ...
                <div class="body table-responsive" style="background-color: white;">
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <asp:ListView ID="lvActions" runat="server"  OnItemDataBound="lvActions_ItemDataBound">
                                <ItemTemplate>
                                    <tr style="width: 70%;">
                                       ...
                                       <td><strong><%#Eval("HotelName") %></strong></td>
                                        ...
                                        <td style="text-align: right;">
                                            <%#Eval("Status").ToString() != "1" ? "<a href=\"ActionAdmin.aspx?ActionId="+Eval("ActionId")+"\" class=\"btn bg-grey waves-effect\"><i class=\"material-icons\">check_circle</i></a>": "" %>
                                            <a href="ActionDetail.aspx?ActionId=<%#Eval("ActionId") %>" class="btn bg-grey waves-effect fancybox" data-fancybox-type="iframe" data-width="65%" data-height="73%"><i class="material-icons">open_in_new</i></a>
                                        </td>
                                    </tr>
                                </ItemTemplate>
                            </asp:ListView>
