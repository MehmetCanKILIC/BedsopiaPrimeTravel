<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CocktailForm.aspx.cs" Inherits="Bedsopia_Prime_Travel.CocktailForm" %>
            ...
            <div class="girisBolumSag">
                ...
                <div style="background-color: white;">
                    <div style="margin-bottom: 10px; width: 100%; height: 100%; text-align: center; position: center;">
                        <img src="Images/CocktailForm.jpeg" style="margin-top: 30px; width: 90%; height: 90%; text-align: center; position: center;" />
                    </div>
                    ...
                    <div style="width: 100%; padding: 38px; background-image: url('../images/form_bg.png');">
                        ...
                        <div class="input-group">
                            ...
                            <div class="form-line">
                                <asp:TextBox ID="txtAttendeesName" runat="server" CssClass="form-control" placeholder="Attendees Name"></asp:TextBox>
                            </div>
                        </div>
                        <div class="input-group">
                            <span class="input-group-addon">
